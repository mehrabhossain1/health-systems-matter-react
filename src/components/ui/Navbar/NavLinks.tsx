    ...
    <div className="bg-[#383F6D] sticky top-0 z-50">
      <NavigationMenu className="h-16 max-w-screen-xl gap-5 mx-auto">
        <NavigationMenuList className="flex md:gap-20">
          ...
          <div>
            <NavigationMenuItem>
              <NavigationMenuTrigger className="p-2 text-xl font-semibold text-[#55D5FE] transition duration-300 ease-in-out transform rounded-md shadow-lg hover:scale-105 pulse-animation">
                About Sizear
              </NavigationMenuTrigger>
