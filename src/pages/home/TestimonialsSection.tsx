...
const testimonials = [
  ...
  {
    image:
      "https://www.citypng.com/public/uploads/preview/black-round-female-user-profile-icon-transparent-png-701751694974954hfwdd9dbfj.png",
    name: "Dr. Emily Davis",
...
const TestimonialsSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl px-6 mx-auto mb-10">
        <div className="flex flex-row-reverse items-center justify-center gap-10 pb-10">
        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            ...
            />
            <blockquote className="px-10 text-sm text-lg italic font-medium text-gray-600">
              "{testimonials[currentIndex].quote}"
            </blockquote>
            <h3 className="text-lg font-semibold text-gray-800">
              {testimonials[currentIndex].name}
            </h3>
            <p className="text-[#01748D] text-sm">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 p-3 m-4 text-gray-700 transition transform -translate-y-1/2 bg-gray-200 rounded-full shadow-md dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 top-1/2"
          >
            <FaChevronLeft size={20} />
          </button>
          <button
            onClick={handleNext}
            className="absolute right-0 p-3 m-4 text-gray-700 transition transform -translate-y-1/2 bg-gray-200 rounded-full shadow-md dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 top-1/2"
          >
